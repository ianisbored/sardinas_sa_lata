...
Jeepneys are public utility vehicles (PUV) that currently serve as the most common public transportation mode in the Philippines (Aruta et al., 2024). They are refurbished US military jeeps left over from World War II with attached carriages, forming the modern jeepney (Eugenio, 2025) that now serve 8,959,000 passengers nationwide (Mateo-Babiano, 2020). According to Statista dated October 2021, in Metro Manila alone, about 55,000 jeepneys roam the roads, with an estimated 240,000 total units nationwide. 

Beyond the highways, the jeepney is an integral part of Philippine culture, identity, and values. Its design, adorned with intentional graffiti, stickers, and paintings ties pop culture, religion, and tradition into a moving artwork, crowning it the “King of the Road”. The unique interactions such as the passing of fares, non-seating transit (sabit sa jeep), and kandungan between the passengers, driver, and barker further solidify jeepneys as a cultural experience beyond its transportation role (Cerio, 2017).

Despite its cultural values, the jeepney poses significant concerns for both environmental health and passenger safety. Due to the semi-enclosed environment and dilapidated diesel engines, the driver and passengers are easily exposed to pollutants such as carbon dioxide (CO2), particulate matter (PM), carbon monoxide (CO), nitrogen oxides (NOx), sulfur oxides (SOx), and volatile organic compounds (VOCs) (Biona, 2017; Balanay, 2007). In addition, Roxas (2025) noted that Metro Manila’s equivalent sound pressure levels average at 70.606dB, reaching the 70dB limit before causing hearing damage and impacting human behavior, adding noise pollution alongside airborne contamination. 

Accessibility is also one of the critical flaws of the modern jeepney. In a recent study conducted by Francisco et al. (2024), they found that when senior citizens struggle from poor audiovisual cognition, it limits them from properly reading jeepney signage and hearing a driver’s stop cue. 

Passenger safety is also a prominent concern as 90% of jeepneys are 15 years or older. The government’s Public Utility Vehicle Modernization Program (PUVMP) aims to address this. However, due to the costs of maintenance and fare these modern jeepneys, drivers and passengers alike have not been in favor of them (Zulueta et al., 2024). 

According to the City Council of Manila, Gagalangin, Tondo, Manila is located on Eastern Tondo, covered by the 2nd District of Manila and is an active hub for jeepney transportation because of its ease of access, high volume, and price. Despite the active role of jeepneys in transportation, and by extension, in Gagalangin’s economy, feedback from commuters is under-documented. It is understood that Gagalangin’s streets are often congested, but the factors behind its traffic are overlooked due to lack of route analysis, causing delays and road rage (McFarlane, 2024 & Capellan, 2022).
